...
def main():
    ...
    with col_btn:
        generate_btn = st.button("🚀 立即生成", type="primary", use_container_width=True) # button用这个参数是完全没问题的
    ...
    if generate_btn:
        with st.spinner("✨ AI 正在生成内容，请稍候..."):
            ...
            if result.startswith("❌"):
                ...
                # ✅ 核心修复：删除了 text_area 里无效的 use_container_width=True 参数
